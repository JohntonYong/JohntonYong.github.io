...
[Linux 内核组织](https://www.kernel.org/) 是一家成立于 2002 年的加州公益公司，旨在免费向公众分发 Linux 内核和其他开源软件。我们已被美国国税局认定为 501(c)3 条款下的私营运营基金会。
...
[riscv官网](https://riscv.org/)和[RISC-V交叉编译工具链](https://github.com/riscv-collab/riscv-gnu-toolchain)
RISC-V 及其生态系统提供了一个开放、可扩展的指令集架构，使设计人员能够创建优化的、可定制的计算解决方案，从定制处理器到硬件/软件协同设计。
